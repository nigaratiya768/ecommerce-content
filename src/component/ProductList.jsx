...
const products = [
  ...
  },
  {
    ...
    product_description: "Multi-port docking station for laptops and tablets.",
    image: "https://example.com/docking_station.jpg",
    price: 89.99,
  },
  {
    product_id: 5,
    product_name: "Portable SSD",
    product_description: "1TB high-speed external SSD for fast data transfer.",
